...
tf.app.flags.DEFINE_bool("curriculum_learning", True, "Group lines so that batch has similar lens")
...
train_feed = StateDataLoader("train", train_data, curriculum_learning=FLAGS.curriculum_learning)
